...
// set output filename 
$filename = $serverRoot . "/outputFiles/FridayReviewers_" . date("Y") . ".csv";


//$con=mysqli_connect("127.0.0.1","photography","photogroup", "photography");
// all reviewers for the current year attending day 1
$query = "SELECT CONCAT(Lname, ', ', Fname), Email, D1Morning, D1Midday, D1Afternoon FROM REVIEWER WHERE (D1Morning = 1 OR D1Midday = 1 OR D1Afternoon = 1)";
